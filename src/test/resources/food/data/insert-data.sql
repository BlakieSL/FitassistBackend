...
INSERT INTO food (name, calories, carbohydrates, fat, protein, food_category_id) VALUES
                                                                                     ('Apple', 95, 25, 0.3, 0.5, 1),
...
INSERT INTO user (email, password, username, gender, birthday, activity_level, goal, height, weight) VALUES
                                                                                                         ('user1@example.com', '$2a$10$exampleHash1', 'user1', 'MALE', '1990-01-01', 'MODERATELY_ACTIVE', 'BUILD_MUSCLE', 175.00, 70.00),
                                                                                                         ('user2@example.com', '$2a$10$exampleHash2', 'user2', 'FEMALE', '1992-03-15', 'SEDENTARY', 'LOSE_WEIGHT', 165.00, 60.00);
