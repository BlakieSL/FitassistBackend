...
INSERT INTO plan (is_public, name, description, structure_type, user_id, created_at)
VALUES (true, '3-Day Beginner Plan', 'A 3-day plan for beginners', 'WEEKLY_SPLIT', 1, NOW()),
...
VALUES ('Full Body Strength', 60, 1, 1, 1),
       ('Upper Body Push', 45, 1, 2, 1),
       ('Lower Body Focus', 60, 2, 1, 2),
       ('Cardio & Core', 30, 3, 1, 0);

INSERT INTO workout_set (order_index, rest_seconds, workout_id)
VALUES (1, 60, 1),
       (2, 90, 1),
       (1, 60, 2),
       (1, 60, 3),
