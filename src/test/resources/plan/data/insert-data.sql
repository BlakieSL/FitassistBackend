...
INSERT INTO plan_category_association (id, plan_id, plan_category_id)
VALUES (1, 1, 1),
       (2, 1, 3),
       (3, 2, 3),
       (4, 3, 2),
...
INSERT INTO user_plan (id, type, plan_id, user_id, created_at)
VALUES (1, 'LIKE', 1, 2, NOW()),
       (2, 'LIKE', 3, 1, NOW()),
       (3, 'SAVE', 2, 3, NOW()),
       (4, 'DISLIKE', 1, 3, NOW()),
       (5, 'SAVE', 4, 1, NOW()),
...
INSERT INTO text (type, id, order_index, text, title, plan_id)
VALUES ('PLAN_INSTRUCTION', 1, 1, 'Warm up for 10 minutes before starting', 'Warm Up', 1),
...
VALUES (1, 'plan1_image1.jpg', 1, 'PLAN'),
