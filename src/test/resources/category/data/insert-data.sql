...
INSERT INTO user (username, password, email, birthday, gender)
VALUES ('user1', 'pass1', 'user1@example.com', '1990-01-01', 'MALE'),
...
INSERT INTO food (name, calories, protein, fat, carbohydrates, food_category_id)
VALUES ('Apple', 52, 0.3, 0.2, 14, 1),
       ('Carrot', 41, 0.9, 0.2, 10, 2),
       ('Oats', 389, 17, 7, 66, 3),
       ('Chicken', 165, 31, 3.6, 0, 4),
       ('Yogurt', 59, 10, 0.4, 3.6, 5);

INSERT INTO activity (met, name, activity_category_id)
VALUES (7.0, 'Running', 1),
       (5.0, 'Weightlifting', 2),
       (3.0, 'Yoga', 3),
       (2.5, 'Tai Chi', 4),
       (8.0, 'Basketball', 5);

INSERT INTO plan (is_public, description, name, structure_type, user_id, created_at)
VALUES (true, 'Weight loss program', 'Slim Down', 'WEEKLY_SPLIT', 1, NOW()),
...
INSERT INTO recipe (is_public, description, name, user_id, created_at)
VALUES (true, 'Healthy breakfast', 'Morning Oats', 1, NOW()),
...
VALUES ('Chest press', 'Bench Press', 4, 3, 1, 1),
