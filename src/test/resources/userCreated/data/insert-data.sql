...
INSERT INTO recipe (is_public, name, description, user_id, created_at) VALUES
                                                    ...
                                                    (false, 'Private Recipe', 'This is a private recipe for testing', 1, NOW());
...
INSERT INTO plan (is_public, name, description, user_id, plan_type_id, created_at) VALUES
                                                                ...
                                                                (false, 'Private Plan', 'This is a private plan for testing', 1, 1, NOW());
...
INSERT INTO comment (text, dateCreated, thread_id, user_id, parent_comment_id) VALUES
                                                                                   ('Start with bodyweight exercises and focus on form!', '2025-11-13 20:55:00.123456', 1, 2, NULL),
                                                                                   ('Thanks for the advice!', '2025-11-13 20:55:30.654321', 1, 1, 1),
