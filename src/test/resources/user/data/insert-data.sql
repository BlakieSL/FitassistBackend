...
INSERT INTO expertise_level (name)
VALUES ('Beginner'),
       ('Intermediate'),
       ('Advanced');
...
INSERT INTO force_type (name)
VALUES ('Push'),
       ('Pull'),
       ('Static');

INSERT INTO mechanics_type (name)
VALUES ('Compound'),
       ('Isolation');

INSERT INTO target_muscle (name)
VALUES ('Chest'),
       ('Back'),
       ('Legs'),
       ('Arms'),
...
VALUES (true, 'Protein Shake', 'Quick post-workout shake', 1, NOW()),
       (true, 'Chicken & Rice', 'Simple meal prep recipe', 2, NOW()),
       (true, 'Greek Yogurt Parfait', 'Healthy breakfast option', 3, NOW());

INSERT INTO recipe_category_association (recipe_id, recipe_category_id)
VALUES (1, 4),
       (2, 2),
       (2, 3),
       (3, 1);
...
INSERT INTO plan (is_public, name, description, user_id, structure_type, created_at)
VALUES (true, 'Summer Cut', '12-week fat loss program', 1, 'WEEKLY_SPLIT', NOW()),
...
INSERT INTO plan_category_association (plan_id, plan_category_id)
VALUES (1, 1),
       (2, 2),
       (3, 3);

INSERT INTO workout (name, duration, plan_id, order_index, rest_days_after)
VALUES ('Upper Body A', 60.00, 1, 1, 1),
       ('Lower Body A', 45.00, 1, 2, 2),
       ('Push Day', 75.00, 2, 1, 1),
       ('Pull Day', 75.00, 2, 2, 1),
       ('Full Body', 50.00, 3, 1, 0);

INSERT INTO workout_set (workout_id, order_index, rest_seconds)
VALUES (1, 1, 90),
       (1, 2, 60),
       (2, 1, 120),
       (3, 1, 90),
...
INSERT INTO comment (text, created_at, thread_id, user_id, parent_comment_id)
VALUES ('Start with bodyweight exercises and focus on form!', '2025-11-13 20:50:00.123456', 1, 2, NULL),
...
INSERT INTO user_activity (user_id, activity_id, created_at)
VALUES (1, 1, NOW()),
       (1, 4, NOW()),
       (2, 2, NOW()),
       (2, 3, NOW()),
...
INSERT INTO user_food (user_id, food_id, created_at)
VALUES (1, 2, NOW()),
       (1, 3, NOW()),
       (2, 1, NOW()),
       (2, 5, NOW()),
...
INSERT INTO user_recipe (user_id, recipie_id, type, created_at)
VALUES (1, 2, 'LIKE', NOW()),
       (1, 2, 'SAVE', NOW()),
       (2, 3, 'LIKE', NOW()),
       (3, 1, 'SAVE', NOW()),
...
INSERT INTO user_plan (user_id, plan_id, type, created_at)
VALUES (1, 1, 'SAVE', '2025-11-01 10:00:00'),
...
INSERT INTO user_comment (user_id, comment_id, type, created_at)
VALUES (1, 3, 'LIKE', NOW()),
       (2, 1, 'LIKE', NOW()),
       (3, 5, 'LIKE', NOW()),
...
INSERT INTO user_thread (user_id, thread_id, created_at)
VALUES (1, 2, NOW()),
       (2, 3, NOW()),
       (3, 2, NOW());

INSERT INTO daily_cart (user_id, date)
VALUES (1, CURDATE()),
       (2, CURDATE()),
       (3, CURDATE());
...
INSERT INTO media (image_name, parent_id, parentType)
VALUES ('user1-profile.jpg', 1, 'USER'),
