...
VALUES ('LIGHTLY_ACTIVE', '1990-05-15', 'user1@example.com', 'MALE', 'BUILD_MUSCLE', 175.50, '$2a$10$examplehash',
        'john_doe', 75.20),
       ('MODERATELY_ACTIVE', '1985-08-22', 'user2@example.com', 'FEMALE', 'LOSE_WEIGHT', 165.00, '$2a$10$examplehash',
        'jane_smith', 68.50),
       ('SEDENTARY', '1995-02-10', 'user3@example.com', 'MALE', 'MAINTAIN_WEIGHT', 180.20, '$2a$10$examplehash',
        'mike_jones', 82.00),
       ('VERY_ACTIVE', '1988-11-30', 'user4@example.com', 'FEMALE', 'BUILD_MUSCLE', 168.50, '$2a$10$examplehash',
        'sarah_williams', 62.30),
       ('SUPER_ACTIVE', '1992-07-18', 'user5@example.com', 'MALE', 'LOSE_WEIGHT', 172.80, '$2a$10$examplehash',
        'david_brown', 78.60);
...
VALUES (NOW(), 'What is the best workout for beginners?', 'Beginner Workout', 125, 1, 1),
...
VALUES ('I recommend starting with bodyweight exercises', '2025-11-13 08:35:00.123456', NULL, 1, 2),
...
INSERT INTO complaint (type, reason, status, user_id, comment_id, thread_id)
VALUES ('COMMENT_COMPLAINT', 'INAPPROPRIATE_CONTENT', 'PENDING', 1, 3, NULL),
