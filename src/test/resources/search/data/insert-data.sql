...
INSERT INTO recipe (name, description, user_id) VALUES ('Protein-Packed Breakfast Bowl', 'A healthy bowl with eggs, yogurt, and fruit.', (SELECT id FROM user WHERE username = 'testuser')), ('Grilled Chicken & Veggies', 'Simple grilled chicken breast with roasted broccoli.', (SELECT id FROM user WHERE username = 'testuser')), ('Salmon & Rice Dinner', 'Baked salmon served with brown rice and steamed vegetables.', (SELECT id FROM user WHERE username = 'testuser'));

INSERT INTO plan (name, description, plan_type_id, user_id) VALUES ('Beginner Full Body Workout', 'A simple plan for starting out.', (SELECT id FROM plan_type WHERE name = 'Workout Plan'), (SELECT id FROM user WHERE username = 'testuser')), ('High-Protein Nutrition Guide', 'Meal ideas focusing on protein intake.', (SELECT id FROM plan_type WHERE name = 'Nutrition Plan'), (SELECT id FROM user WHERE username = 'testuser')), ('Fat Loss Hybrid Plan', 'Combines workouts and diet for fat loss.', (SELECT id FROM plan_type WHERE name = 'Hybrid Plan'), (SELECT id FROM user WHERE username = 'testuser'));
