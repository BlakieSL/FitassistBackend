INSERT INTO user (id, username, email, password, birthday, gender) VALUES
...
INSERT INTO food (id, name, calories, carbohydrates, fat, protein, food_category_id) VALUES
(1, 'Carrot', 41, 9.6, 0.2, 0.9, 1),
...
INSERT INTO recipe (is_public, id, name, description, minutes_to_prepare, user_id, created_at) VALUES
...
INSERT INTO recipe_category_association (id, recipe_id, recipe_category_id) VALUES
(1, 1, 1),
(2, 1, 3),
(3, 2, 2),
(4, 3, 2),
...
INSERT INTO recipe_food (id, quantity, recipe_id, food_id) VALUES
(1, 200, 1, 1),
(2, 150, 2, 2),
(3, 100, 3, 2),
(4, 150, 3, 3),
...
INSERT INTO user_recipe (id, type, recipie_id, user_id, created_at) VALUES
(1, 'SAVE', 1, 1, NOW()),
(2, 'LIKE', 2, 1, NOW()),
(3, 'SAVE', 3, 1, NOW()),
(4, 'LIKE', 3, 1, NOW());
