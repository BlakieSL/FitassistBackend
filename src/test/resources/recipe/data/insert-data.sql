...
INSERT INTO recipe (id, name, description, user_id)
VALUES
    (1, 'Vegetable Stir Fry', 'Healthy vegetable dish', 1),
    (2, 'Grilled Chicken', 'High protein meal', 1),
    (3, 'Chicken Rice Bowl', 'Balanced meal with protein and carbs', 1);
