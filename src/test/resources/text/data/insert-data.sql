...
INSERT INTO food (id, calories, carbohydrates, fat, name, protein, food_category_id) VALUES
(1, 35.0, 7.0, 0.2, 'Carrot', 0.8, 1);

INSERT INTO recipe (is_public, id, description, name, user_id, created_at) VALUES
