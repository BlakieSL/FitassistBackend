...
public class AwsS3ContainerInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
	...
	static LocalStackContainer localStack = new LocalStackContainer(DockerImageName.parse("localstack/localstack:4.4"))
	...
	public void initialize(ConfigurableApplicationContext applicationContext) {
		...
		TestPropertyValues
			.of("spring.cloud.aws.s3.enabled=true", "spring.cloud.aws.s3.endpoint=" + endpoint,
					"spring.cloud.aws.credentials.access-key=test", "spring.cloud.aws.credentials.secret-key=test",
					"spring.cloud.aws.region.static=" + localStack.getRegion(), "s3.bucket.name=test-bucket")
