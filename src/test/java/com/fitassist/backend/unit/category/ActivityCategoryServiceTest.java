...
import com.fitassist.backend.service.implementation.category.ActivityCategoryServiceImpl;
...
public class ActivityCategoryServiceTest {
	...
	void updateCategory_shouldThrowExceptionWhenPatchFails() throws JsonPatchException, JsonProcessingException {
		...
		assertThrows(JsonPatchException.class, () -> activityCategoryService.updateCategory(categoryId, patch));
	...
	void updateCategory_shouldThrowExceptionWhenValidationFails() throws JsonPatchException, JsonProcessingException {
		...
		assertThrows(RuntimeException.class, () -> activityCategoryService.updateCategory(categoryId, patch));
	...
	void getAllCategories_shouldThrowExceptionWhenCacheIsNull() {
		...
		assertThrows(NullPointerException.class, () -> activityCategoryService.getAllCategories());
	...
	void getCategory_shouldThrowRecordNotFoundExceptionWhenCategoryNotFound() {
		...
		assertThrows(RecordNotFoundException.class, () -> activityCategoryService.getCategory(nonExistentCategoryId));
