...
import com.fitassist.backend.service.implementation.category.PlanCategoryServiceImpl;
...
public class PlanCategoryServiceTest {
	...
	void updateCategory_shouldThrowExceptionWhenPatchFails() throws JsonPatchException, JsonProcessingException {
		...
		assertThrows(JsonPatchException.class, () -> planCategoryService.updateCategory(categoryId, patch));
	...
	void updateCategory_shouldThrowExceptionWhenValidationFails() throws JsonPatchException, JsonProcessingException {
		...
		assertThrows(RuntimeException.class, () -> planCategoryService.updateCategory(categoryId, patch));
	...
	void deleteCategory_shouldThrowExceptionWhenCategoryNotFound() {
		...
		assertThrows(RecordNotFoundException.class, () -> planCategoryService.deleteCategory(nonExistentCategoryId));
	...
	void getAllCategories_shouldThrowExceptionWhenCacheIsNull() {
		...
		assertThrows(NullPointerException.class, () -> planCategoryService.getAllCategories());
	...
	void getCategory_shouldThrowRecordNotFoundExceptionWhenCategoryNotFound() {
		...
		assertThrows(RecordNotFoundException.class, () -> planCategoryService.getCategory(nonExistentCategoryId));
