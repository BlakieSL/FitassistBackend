...
import com.fitassist.backend.service.implementation.category.FoodCategoryServiceImpl;
...
public class FoodCategoryServiceTest {
	...
	@Mock
	private CategoryCacheKeyGenerator<FoodCategory> cacheKeyGenerator;
	...
	void updateCategory_shouldThrowExceptionWhenPatchFails() throws JsonPatchException, JsonProcessingException {
		...
		assertThrows(JsonPatchException.class, () -> foodCategoryService.updateCategory(categoryId, patch));
	...
	void updateCategory_shouldThrowExceptionWhenValidationFails() throws JsonPatchException, JsonProcessingException {
		...
		assertThrows(RuntimeException.class, () -> foodCategoryService.updateCategory(categoryId, patch));
	...
	void deleteCategory_shouldThrowExceptionWhenCategoryNotFound() {
		...
		assertThrows(RecordNotFoundException.class, () -> foodCategoryService.deleteCategory(nonExistentCategoryId));
	...
	void getAllCategories_shouldThrowExceptionWhenCacheIsNull() {
		...
		assertThrows(NullPointerException.class, () -> foodCategoryService.getAllCategories());
	...
	void getCategory_shouldThrowRecordNotFoundExceptionWhenCategoryNotFound() {
		...
		assertThrows(RecordNotFoundException.class, () -> foodCategoryService.getCategory(nonExistentCategoryId));
