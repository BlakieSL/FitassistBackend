...
public class CategoryControllerDeleteCategoryTest {
    ...
    void deleteFoodCategory() throws Exception {
        ...
        mockMvc.perform(delete("/api/categories/FOOD/6"))
                .andExpect(status().isNoContent());

        mockMvc.perform(get("/api/categories/FOOD/6"))
    ...
    void deleteNonExistentFoodCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/FOOD/999"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteFoodCategoryAsNonAdmin() throws Exception {
        ...
        mockMvc.perform(delete("/api/categories/FOOD/1"))
    ...
    void deleteActivityCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/ACTIVITY/6"))
                .andExpect(status().isNoContent());
    }
    ...
    void deleteNonExistentActivityCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/ACTIVITY/999"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteActivityCategoryAsNonAdmin() throws Exception {
        Utils.setUserContext(2);
        mockMvc.perform(delete("/api/categories/ACTIVITY/1"))
                .andExpect(status().isForbidden());
    }
    ...
    void deleteRecipeCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/RECIPE/6"))
                .andExpect(status().isNoContent());

        mockMvc.perform(get("/api/categories/RECIPE/6"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteNonExistentRecipeCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/RECIPE/999"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteRecipeCategoryAsNonAdmin() throws Exception {
        Utils.setUserContext(2);
        mockMvc.perform(delete("/api/categories/RECIPE/1"))
                .andExpect(status().isForbidden());
    }
    ...
    void deletePlanCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/PLAN/6"))
                .andExpect(status().isNoContent());

        mockMvc.perform(get("/api/categories/PLAN/6"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteNonExistentPlanCategory() throws Exception {
        Utils.setAdminContext(1);
        mockMvc.perform(delete("/api/categories/PLAN/999"))
                .andExpect(status().isNotFound());
    }
    ...
    void deletePlanCategoryAsNonAdmin() throws Exception {
        Utils.setUserContext(2);
        mockMvc.perform(delete("/api/categories/PLAN/1"))
                .andExpect(status().isForbidden());
    }
