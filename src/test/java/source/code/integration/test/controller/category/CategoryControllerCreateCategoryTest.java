...
public class CategoryControllerCreateCategoryTest {
    ...
    void createFoodCategory() throws Exception {
        ...
        mockMvc.perform(post("/api/categories/FOOD")
                ...
                .andExpectAll(
                        status().isCreated(),
                        jsonPath("$.name").value("New Food Category")
                );
    }
    ...
    void createActivityCategory() throws Exception {
        ...
        mockMvc.perform(post("/api/categories/ACTIVITY")
                ...
                .andExpectAll(
                        status().isCreated(),
                        jsonPath("$.name").value("New Activity Category")
                );
    }
    ...
    void createRecipeCategory() throws Exception {
        ...
        mockMvc.perform(post("/api/categories/RECIPE")
                ...
                .andExpectAll(
                        status().isCreated(),
                        jsonPath("$.name").value("New Recipe Category")
                );
    }
    ...
    void createPlanCategory() throws Exception {
        ...
        mockMvc.perform(post("/api/categories/PLAN")
                ...
                .andExpectAll(
                        status().isCreated(),
                        jsonPath("$.name").value("New Plan Category")
                );
    }
