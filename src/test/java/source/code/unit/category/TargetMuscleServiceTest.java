...
import source.code.service.implementation.category.TargetMuscleServiceImpl;
...
public class TargetMuscleServiceTest {
    @Mock
    ...
    @Mock
    private CategoryCacheKeyGenerator<TargetMuscle> cacheKeyGenerator;
    ...
    @Mock
    private TargetMuscleRepository repository;

    @Mock
    private TargetMuscleMapper mapper;

    @InjectMocks
    private TargetMuscleServiceImpl targetMuscleService;

    private CategoryCreateDto createDto;
    private TargetMuscle category;
    ...
    void createCategory_shouldCreate() {
        ...
        CategoryResponseDto result = targetMuscleService.createCategory(createDto);
    ...
    void createCategory_shouldPublishEvent() {
        ...
        targetMuscleService.createCategory(createDto);
    ...
    void updateCategory_shouldUpdate() throws JsonPatchException, JsonProcessingException {
        ...
        targetMuscleService.updateCategory(categoryId, patch);
    ...
    void updateCategory_shouldThrowExceptionWhenCategoryNotFound() {
        ...
        assertThrows(RecordNotFoundException.class, () ->
                targetMuscleService.updateCategory(nonExistentCategoryId, patch));
    ...
    void deleteCategory_shouldDelete() {
        ...
        targetMuscleService.deleteCategory(categoryId);
    ...
    void deleteCategory_shouldThrowExceptionWhenCategoryNotFound() {
        ...
        assertThrows(RecordNotFoundException.class, () ->
                targetMuscleService.deleteCategory(nonExistentCategoryId));
    ...
    void getAllCategories_shouldReturnCachedCategories() {
        ...
        List<CategoryResponseDto> result = targetMuscleService.getAllCategories();
    ...
    void getAllCategories_shouldThrowExceptionWhenCacheIsNull() {
        ...
        assertThrows(NullPointerException.class, () ->
                targetMuscleService.getAllCategories()
        );
    ...
    void getCategory_shouldReturnCategoryWhenFound() {
        ...
        CategoryResponseDto result = targetMuscleService.getCategory(categoryId);
    ...
    void getCategory_shouldThrowRecordNotFoundExceptionWhenCategoryNotFound() {
        ...
        assertThrows(RecordNotFoundException.class, () ->
                targetMuscleService.getCategory(nonExistentCategoryId));;
