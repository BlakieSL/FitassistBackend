...
public class GenericSpecificationHelper {
    ...
    public static <T> Predicate buildPredicateEntityProperty(PredicateContext<T> context,
                                                             String joinProperty) {
    ...
    public static <T, J> Predicate buildPredicateJoinProperty(PredicateContext<T> context,
                                                              Join<T, J> join,
                                                              String subJoinProperty) {
        var value = validateAndGetId(context.criteria());
        return buildCollectionIdBasedPredicate(context.builder(), context.criteria(),
                join, subJoinProperty, value);
    }

    public static <T> Predicate buildPredicateNumericProperty(PredicateContext<T> context,
    ...
    public static <T> Predicate buildSavedByUserPredicate(PredicateContext<T> context,
