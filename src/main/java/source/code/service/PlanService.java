...
public class PlanService {
    ...
    @Transactional
    public PlanResponseDto savePlan(PlanCreateDto planDto) {
    ...
    public List<PlanResponseDto> getPlansByUserID(int userId) {
    ...
    public List<PlanCategoryResponseDto> getCategories() {
