...
public class WorkoutSetExerciseServiceImpl implements WorkoutSetExerciseService {
	...
	public WorkoutSetExerciseServiceImpl(JsonPatchService jsonPatchService, ValidationService validationService,
										 WorkoutSetExerciseMapper workoutSetExerciseMapper, RepositoryHelper repositoryHelper,
	...
	public WorkoutSetExerciseResponseDto createWorkoutSetExercise(WorkoutSetExerciseCreateDto createDto) {
		WorkoutSetExercise workoutSetExercise = workoutSetExerciseRepository
			.save(workoutSetExerciseMapper.toEntity(createDto));
	...
	public List<WorkoutSetExerciseResponseDto> getAllWorkoutSetExercisesForWorkoutSet(int workoutSetId) {
		return workoutSetExerciseRepository.findAllByWorkoutSetId(workoutSetId)
			.stream()
