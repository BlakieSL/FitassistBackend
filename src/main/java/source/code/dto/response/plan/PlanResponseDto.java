 ...
 * totalWeeks (via @AfterMapping), planStructureType, workouts (with
 * weekIndex/dayOfWeekIndex via @AfterMapping), instructions, categories Population sets:
 * author.imageName, author.imageUrl, imageUrls, likesCount, dislikesCount, savesCount,
