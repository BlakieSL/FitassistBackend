package source.code.controller.workoutSetExercise;
...
public class WorkoutSetExerciseController {
    ...
    public ResponseEntity<WorkoutSetExerciseResponseDto> getWorkoutSetExercise(@PathVariable int workoutSetExerciseId) {
        WorkoutSetExerciseResponseDto workoutSetExercise = workoutSetExerciseService.getWorkoutSetExercise(workoutSetExerciseId);
