 ...
 * (findByIdsWithDetails) -> mapper -> populated in UserRecipeService.getAllFromUser
 *
 * <p>
 * Mapper sets: id, name, description, isPublic, createdAt, minutesToPrepare, views,
 * categories, author (id, username), firstImageName (from mediaList) Population sets:
 * firstImageUrl, author.imageName/imageUrl, likesCount, dislikesCount, savesCount, liked,
 * disliked, saved, ingredientsCount
 *
 * <p>
 * interactedWithAt - only set in UserRecipeService.getAllFromUser liked/disliked/saved -
...
@NoArgsConstructor
@AllArgsConstructor
public class RecipeSummaryDto implements UserEntitySummaryResponseDto, Serializable {
